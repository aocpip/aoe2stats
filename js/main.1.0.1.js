...
function reload(version) {
	...
	unit_table.ajax.url("stats/"+version+"_units.json"+stats_version).load();
	structure_table.ajax.url("stats/"+version+"_structures.json"+stats_version).load();
	technology_table.ajax.url("stats/"+version+"_technologies.json"+stats_version).load();
	civilization_table.ajax.url("stats/"+version+"_civilizations.json"+stats_version).load();
	gathering_table.ajax.url("stats/"+version+"_gathering.json"+stats_version).load();
...
function initTables(version) {
	...
	unit_table = $('#unit-stats').DataTable({
		"ajax": "stats/"+version+"_units.json"+stats_version,
		"fixedHeader" : {
			"header": false,
			"footer": true,
			"footerOffset": -6
	...
	structure_table = $('#structure-stats').DataTable({
		"ajax": "stats/"+version+"_structures.json" + stats_version,
		"fixedHeader" : {
			"header": false,
			"footer": true,
			"footerOffset": -6
	...
	technology_table = $('#technology-stats').DataTable({
		"ajax": "stats/"+version+"_technologies.json" + stats_version,
		"fixedHeader" : {
			"header": false,
			"footer": true,
			"footerOffset": -6
	...
	civilization_table = $('#civilization-stats').dataTable({
		"ajax": "stats/"+version+"_civilizations.json"+stats_version,
		"fixedHeader" : {
			"header": false,
			"footer": true,
			"footerOffset": -6
	...
	gathering_table = $('#gathering-stats').DataTable({
		"ajax": "stats/"+version+"_gathering.json"+stats_version,
		"fixedHeader" : {
			"header": false,
			"footer": true,
			"footerOffset": -6
