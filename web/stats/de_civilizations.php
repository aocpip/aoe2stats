...
$changes_json = <<<JSON
{
	...
	"Franks": {
		...
		"bs": "<ul><li>Foragers work 25% faster</li><li>Castles are 25% cheaper.</li><li>Cavalry has +20% HP (Starting in Feudal Age).</li><li>Farm upgrades are free (Mill is required to receive bonus).</li></ul>",
		"tt": "franks"
	},
	"Goths": {
		"tt": "goths"
	...
	"Koreans": {
		...
		"bs": "<ul><li>Villagers have +3 line of sight.</li> <li>Stone miners work 20% faster.</li> <li>Guard Tower and Keep upgrades are free.</li> <li>Towers (except bombard towers) have +1 range in Castle Age, +2 in Imperial Age.</li><li>Military units (except Siege weapons) cost -15% wood</ul>",
		"tt": "koreans"
	},
	"Mayans": {
	...
	"Saracens": {
		...
		"bs": "<ul> <li>Market costs -100 wood.</li><li>Market trade cost is only 5%.</li> <li>Transport Ships have 2x HP and carry capacity.</li> <li>Galleys attack 20% faster.</li> <li>All Archers (except Skirmishers) have +3 attack bonus against buildings.</li> </ul>",
		"tt": "saracens"
	},
	"Spanish": {
	...
	"Teutons": {
		...
		"bs": "<ul> <li>Monks have 2x healing range.</li> <li>Towers can garrison 2x units (more arrows).</li> <li>Murder Holes and Herbal Medication are free.</li> <li>Farms cost 33% less.</li> <li>Town Centers garrison +10 units (total 25), total amount of arrows +5 (max 16).</li> </ul>",
		"tt": "teutons"
	},
	"Turks": {
...
[
	...
	},
	{
		...
		"bs": "<ul> <li>Advancing to the next age costs -15%.</li><li>Dock techs cost -50%</li><li>Fishing ships cost -11 wood.</li><li>Gunpowder units cost -20%.</li> </ul>",
		"tt": "italians"
	},
	{
		"name": "Magyars",
	...
	},
	{
		...
		"bs": "<ul> <li>Farmers work ~10% faster.</li><li>Supplies is free.</li><li>Siege units from siege workshop 15% cheaper.</li> </ul>",
		"tt": "slavs"
	},
	{
		"name": "Portuguese",
	...
	},
	{
		...
		"bs": "<ul> <li>Receive 100 food and 100 gold upon advancing to next age.</li> <li>Pikeman upgrade is free.</li> <li>Foot archers reload time *0.85 (-15%).</li> </ul>",
		"tt": "ethiopians"
	},
	{
		"name": "Malians",
