...
function formatCiv(d, columns) {
	...
	if(d.tt.length > 0) {
		content += "<div style='min-height: 240px;height: 100%;'>";
		content += '<iframe width="100%" height="100%" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="images/techtrees/'+version+'/'+d.tt+'.html"></iframe>';
		content += "</div>";
	}
